...
let slider_about = new Swiper('.main__slider-list', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.main__slider .main__arrow-right',
		prevEl: '.main__slider .main__arrow-left',
	},
	/*
	breakpoints: {
		320: {
...
let slider_aboutt = new Swiper('.rev__all-sliders', {
	...
	// Arrows
	navigation: {
		nextEl: '.rev__wrapper-slider .rev__arrow-right',
		prevEl: '.rev__wrapper-slider .rev__arrow-left',
	},
...
let slider_clients = new Swiper('.clients__wrapper', {
	...
	// Arrows
	navigation: {
		nextEl: '.clients__wrapper-all .clients__arrow-right',
		prevEl: '.clients__wrapper-all .clients__arrow-left',
	},
